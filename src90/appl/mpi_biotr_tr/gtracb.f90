...
!     ------------------------------------------------------------------
!
      SUBROUTINE GTRACB(I, L, IFIRST, NFOUND, BUF, IBUF, LBUF, JLEI, LU) 
!-----------------------------------------------
!   M o d u l e s 
!-----------------------------------------------
      USE vast_kind_param, ONLY:  DOUBLE 
! 1s ineactive, 2 electrons in (1s 1p), Singlet P
! The following is the list in the order : l  j i   r l coef
!
!...Translated by Pacific-Sierra Research 77to90  4.3E  20:39:52  11/18/01  
!...Switches:                     
      IMPLICIT NONE
!-----------------------------------------------
...
!-----------------------------------------------
      DATA IRACAH/ 0, 2, 2, 1, 1, 1, 1, 1, 1, 1/  
!234567
!. Output
!
      DATA RACAH/ 1.0D0, 1.0D0/  
!
