...
! BUF  : LBUF
! IBUF : 4*LBUF
!...Translated by Pacific-Sierra Research 77to90  4.3E  15:14:39  11/20/01  
!...Switches:                     
!-----------------------------------------------
...
!-----------------------------------------------
      ...
      REAL(DOUBLE) , INTENT(IN) :: T(NSHL) 
      REAL(DOUBLE)  :: CIOUT(NCSF,NCIV) 
      REAL(DOUBLE)  :: BUF(LBUF) 
!-----------------------------------------------
!   L o c a l   V a r i a b l e s
!-----------------------------------------------
      INTEGER :: NTESTL, NTEST, IBATCH, IFIRST, NFOUND, IELMNT, J, ILEFT, &
         IRIGHT, IVEC 
      REAL(DOUBLE) :: RACAH, X 
!-----------------------------------------------
!. Input
...
!
      IF (NTEST >= 10) WRITE (6, *) ' Entering TI1TV' 
...
!
      DO IELMNT = 1, NFOUND 
         ...
         J = IBUF(1,IELMNT) 
         X = T(J)*RACAH 
!mrg      ILEFT = IBUF(4,IELMNT)
!mrg      IRIGHT = IBUF(3,IELMNT)
         ILEFT = IBUF(3,IELMNT) 
         IRIGHT = IBUF(4,IELMNT) 
         CIOUT(ILEFT,:NCIV) = CIOUT(ILEFT,:NCIV) + X*CIIN(IRIGHT,:NCIV) 
      END DO 
!
...
!
      ...
      ENDIF 
!
      IF (NTEST >= 10) WRITE (6, *) ' LEAVING TI1TV' 
      RETURN  
      END SUBROUTINE TI1TV 
