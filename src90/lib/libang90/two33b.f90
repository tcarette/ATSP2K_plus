...
! Spin-spin operator
      ...
      DO I1 = IPS1, 2 
         ...
         DO I2 = IPS2, 2 
            ...
            DO I3 = IP1, IG1 
               KKL2 = I3 - 1 
               CALL A1A2W3LSP (IB, IA, IC, IC, KKL2, KKS2, (-HALF), HALF, HALF&
                  , (-HALF), W) 
               IF (DABS(W) < EPS) CYCLE  
               DO I4 = IP, IG 
                  KKL1 = I4 - 1 
                  ...
                  IF (IRL(I4,I3) == 0) THEN 
                     IRL(I4,I3) = 1 
                     CALL RLSP3 (2, IB, IA, IC, 2*ID2(3), 2*ID1(3), 2*KKL1, 2*&
                        KKL2, 2*K, RECL) 
                     RL(I4,I3) = RECL 
                  ELSE 
                     RECL = RL(I4,I3) 
                  ...
                  IF (INA /= 0) THEN 
                     ...
                     IF (MOD(KKL1 + KKS1 + KL1 + KS1 + ID2(3)+ID3(3),2) /= 0) &
                        SLA1 = -SLA1 
                  ELSE 
                     SLA1 = ZERO 
                  ENDIF 
                  IF (INB /= 0) THEN 
                     ...
                     IF (MOD(ID1(3)+ID3(3)-KL2-KS2-KKL2-KKS2,2) /= 0) SLB1 = -&
                        SLB1 
                  ELSE 
                     SLB1 = ZERO 
                  ENDIF 
