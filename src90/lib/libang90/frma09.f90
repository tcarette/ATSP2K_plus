...
!-----------------------------------------------
      INTEGER , DIMENSION(30) :: IS57A 
      INTEGER , DIMENSION(22) :: IS57B 
      INTEGER , DIMENSION(34) :: IS58A 
      INTEGER , DIMENSION(21) :: IS58B 
      INTEGER , DIMENSION(34) :: IS59A 
      INTEGER , DIMENSION(22) :: IS59B 
      INTEGER , DIMENSION(32) :: IS60A 
      INTEGER , DIMENSION(22) :: IS60B 
      INTEGER , DIMENSION(7) :: IS61A 
      INTEGER , DIMENSION(4) :: IS61B 
      INTEGER , DIMENSION(22) :: IS61C 
      INTEGER :: I2 
!-----------------------------------------------
!
      DATA IS57A/ 61440, 8910, -23520, 0, 8085, -120050, -126720, 351, 48510, 3&
         *0, -56056, 2*0, 116424, 2*0, -151200, 2*0, -123200, -14014, 0, -68040&
      ...
      DATA IS59A/ 131040, 13104, 0, 2162160, 0, -786240, -360360, 2*0, 1524600&
         , 0, -554400, -116640, -3259872, 101871, 5489253, -288288, 9009, &
         3764475, 2*0, -2965248, 2*0, 831600, 3244032, 2*0, -302400, 92664, &
         -2573208, -101376, 1346400, 2913120/  
      ...
      DATA IS60B/ -24255, 11466, 8*0, -15120, 31185, 0, -23814, 6*0, 6804, &
         19656/  
