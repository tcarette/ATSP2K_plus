...
c     The method use to sort the data is quick sort with a pivot value
c     that is the larger value of the first 2 different value from the
c     the sublist to be sorted.
c     This sorting method used a stack to maintain the unsorted section,
c     and sorting will be finished when the stack is empty.
