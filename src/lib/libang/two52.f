...
* Spin-spin operator
    ...
    3   CONTINUE
	IF(IREZ.EQ.1) THEN
	  IF(MOD(ID1(3)+ID2(3)+ID3(3)+ID4(3)+KL1+KL2,2).NE.0) CA1=-CA1
	  IF(MOD(ID1(3)+ID2(3)+ID3(3)+ID4(3),2).NE.0) CB1=-CB1
        ELSE
	  IF(MOD(KL1+KL2,2).NE.0) CB1=-CB1
        ENDIF
