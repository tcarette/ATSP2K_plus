...
*       Modified for G. Tachiev for extended calculations and g_J factors
*       Modified by C. Froese Fischer for large calculations [July 2005]
*       .. nze was limited to big (=2**28) at which point idisk=1
*       .. this avoids integer overflow in large cases.
*
...
*	WITH RESTARTING
      ...
      PARAMETER (NOD=220, NWD=94, NTERMD=31)
*
...
*     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
*       nze will be set in breval and possibly idisk will be changed.
        idisk = 0
	restart = .false.
	onlydvd = .false.
