...
Ctc 19/03/2008 : crash of large calculations on several nodes of hydra@ulb
Ctc      WRITE(OUT,63) EL(I),EL(JI),C
         WRITE(80+myid,63) EL(I),EL(JI),C
Ctc
...
61       CONTINUE
     ...
     :              CALL LINEQN(NODD,IJ,AC,BC)
         ...
         DO 65 JJ = 1,IJ
            C = BC(JJ)
Ctc 19/03/2008 : crash of large calculations on several nodes of hydra@ulb
Ctc         WRITE(OUT,63) EL(JV(JJ)),EL(I),C
            WRITE(80+myid,63) EL(JV(JJ)),EL(I),C
Ctc
...
Ctc 19/03/2008 : crash of large calculations on several nodes of hydra@ulb
Ctc   WRITE(OUT,17) EL(I),E(I,I),AZ(I),PN,ASTER(KK),DP
      WRITE(80+myid,17) EL(I),E(I,I),AZ(I),PN,ASTER(KK),DP
Ctc
