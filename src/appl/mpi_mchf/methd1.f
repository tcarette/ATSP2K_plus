...
*
      ...
      NC = NODEC(MN)
Ctc 19/03/2008 : crash of large calculations on several nodes of hydra@ulb
Ctc   IF (TRACE) WRITE(OUT,99) EL(I),NC,MN,NJ,PDE(MN),ED,EU,EM,DELTAE
      IF (TRACE) WRITE(80+myid,99) EL(I),NC,MN,NJ,PDE(MN),ED,EU,EM,
     :                                                            DELTAE
Ctc
...
33    MK = MK + 1
Ctc 19/03/2008 : crash of large calculations on several nodes of hydra@ulb
Ctc   IF ( EU .LE. EM ) WRITE(OUT,30) EM,EU,ED
      IF ( EU .LE. EM ) WRITE(80+myid,30) EM,EU,ED
Ctc
...
*
Ctc 19/03/2008 : crash of large calculations on several nodes of hydra@ulb
Ctc   27    WRITE(OUT,28) KK,EL(I),NC,NJ,ED,EM,EU
27    WRITE(80+myid,28) KK,EL(I),NC,NJ,ED,EM,EU
Ctc
