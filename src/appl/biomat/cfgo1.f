...
*
      NWFD = MAXORB
      print*,' qiajcmp: nwfd = ',nwfd
      call alloc(qiajcmp,nwfd,4)
      print*,' qljcomp: nwfd = ',nwfd
      call alloc(qljcomp,nwfd,4)
      print*,' qnjcomp: nwfd = ',nwfd
      call alloc(qnjcomp,nwfd,4)
      print*,' qnoc: ncfg = ',ncfg
      call alloc(qnoc,ncfg,4)
      print*,' qnelcsh: 8*ncfg = ',8*ncfg
      call alloc(qnelcsh,8*ncfg,4)
      print*,' qnocorb: 8*ncfg = ',8*ncfg
      call alloc(qnocorb,8*ncfg,4)
      print*,' qj1    : 15*ncfg = ',15*ncfg
      call alloc(qj1,15*ncfg,4)
      print*,' qiajcld: nwcd = ',nwcd
      call alloc(qiajcld,nwcd,4)
      print*,' qljclsd: nwcd = ',nwcd
