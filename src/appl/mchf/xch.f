...
*
      POINTER(IQP,P(NOD,10)),(IQN,N(10)),(IQL,L(10)),(IQAZ,AZ(10)),
     :(IQMAX,MAX(20)),(QVARD,VARIED(20)),(QSUM,SUM(20)),(QS,S(20)),
     :(QDPM,DPM(20)),(QACC,ACC(20)),(QMETH,METH(20)),(QIEPTR,IEPTR(20))
...
*        print '(A9,I8,/,A9,I8)','izero=',izero,'inonzero=',
*     :          inonzero
*
