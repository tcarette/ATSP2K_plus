...
C     print *, 'hmx:'
C     print '(3F20.16)', (hmx(i),i=1,jptr(ncfg))
C     print *, 'ih:'
C     print '(4I6)', (ih(i+nz),i=1,jptr(ncfg))
C     print *, 'jptr:', (jptr(i+nj),i=1,ncfg)
C     print *, 'iupper,nze,ncfg,lim:',iupper,nze,ncfg,lim
C     print *, 'diag :'
C     print '(3F20.16)',(hii(i),i=1,ncfg)
C     print *, 'ilow,ihigh,iselec(1),iselec(2),iselec(3)',
C    :          ilow,ihigh,iselec(1),iselec(2),iselec(3)
Cmrg
      call hrestor(ncfg)
Cmrg
...
Cmrg recalcen subroutine not needed but might be helpful
Cmrg  call recalcen(ncfg,eigvec(1),ec,shift)
      call sortcsf(ncfg,eigvec(1),ec,shift)
Cmrg
*<<<<<<<<<<<<<<<<<<end updatc>>>>>>>>>>>>>>>>>>>>>>>>>>>>
