...
ctc same problem as mpi_mchf : conflict in writes
ctc         iscw = 40
ctc         iwrite = 40
         iscw = 40+myid
         iwrite = 40+myid
...
*    .. write block information to cfg.inp
      if(myid == 0) then
Cmrg     write(25,'(3x,A3,I8,I8,i20)') term, ncfg, nij_tot
Cmrg 12/03/2008: I8 -> I10 for large calculations in S-
         write(25,'(3x,A3,I8,I10)') term, ncfg, nij_tot
      end if 
