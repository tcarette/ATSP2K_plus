...
*
     ...
     :' nmult = ',nmult
      if(ibug1.ne.0) print*,' qsl     allocation: nmult    = ',nmult
      call alloc(qsl,nmult,8)
      if(ibug1.ne.0) print*,' qsv     allocation: nmult    = ',nmult
      call alloc(qsv,nmult,8)
      if(ibug1.ne.0) print*,' qil     allocation: nmult    = ',nmult
      call alloc(qil,nmult,4)
      if(ibug1.ne.0) print*,' qir     allocation: nmult    = ',nmult
      call alloc(qir,nmult,4)
      if(ibug1.ne.0) print*,' qjvl    allocation: nmult    = ',nmult
      call alloc(qjvl,nmult,4)
      if(ibug1.ne.0) print*,' qjvr    allocation: nmult    = ',nmult
