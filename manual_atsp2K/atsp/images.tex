...
\documentstyle[epsfig,fullpage]{iopbk}
...
\title{ATSP2K manual}
\author{
G.I. Tachiev and C. Froese Fischer \\
Vanderbilt University\\
{\tt cff@vuse.vanderbilt.edu} \\
{\tt georgio@vuse.vanderbilt.edu} \\
}
...
\stepcounter{section}
{\newpage\clearpage
\lthtmlfigureA{figure990}%
\begin{figure}\begin{center}
\centerline{\epsfig{file=tex/fig/atsp_general.epsi}}\end{center}
\end{figure}%
\lthtmlfigureZ
\lthtmlcheckvsize\clearpage}
